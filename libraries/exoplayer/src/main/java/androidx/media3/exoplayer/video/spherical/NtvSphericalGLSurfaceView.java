 ...
 */
@UnstableApi
public final class NtvSphericalGLSurfaceView extends GLSurfaceView {
    ...
    public NtvSphericalGLSurfaceView(Context context) {
        this(context, null);
    }



    public NtvSphericalGLSurfaceView(Context context, @Nullable AttributeSet attributeSet) {
    ...
    /* package */ public class Renderer
        ...
        public void moveRight() {
            Matrix.setRotateM(touchYawMatrix, 0, ++moveY, 0, 1, 0);
            updatePitchMatrix();
        }
        ...
        public void moveUp() {
            Matrix.setRotateM(touchYawMatrix, 0, --moveX, 1, 0, 0);
            updatePitchMatrix();
        }
